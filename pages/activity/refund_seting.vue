  ...
  <view class="page flex-col">
    ...
    <view class="layer6 flex-col" @tap="cur = 1">
      <view class="group1 flex-row justify-between">
        <text class="txt1">活动结束前均可退款</text>
        <view class="radio_btn flex-col" :class="{active:cur == 1}"></view>
      </view>
    </view>
    <view class="layer7 flex-col" @tap="()=>{cur = 2;refund_date_show = true}">
      <view class="box1 flex-row justify-between">
        <text class="txt2">活动结束前_{{refund_date?refund_date:'_'}}_天可以退款</text>
		...
		<view class="layer1 flex-col">
		  <view class="layer2 flex-col">
		    <view class="bd3 flex-row justify-between">
		      ...
		      />
		      <text class="word4">活动有人付款成功后，则不能更改退款设置</text>
		    </view>
    ...
    onClick_1() {
			...
			switch(this.cur){
				case 1:
					...
					break;
				case 2:
					cause = `活动结束前${this.refund_date}可以退款`
					break;
				case 3:
					cause = '不支持退款'
					break;
