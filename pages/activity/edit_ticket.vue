<template>
  <view class="page flex-col u-p-t-20">
    <view class="box7 flex-col">
      <view class="outer2 flex-row justify-between u-col-center">
    ...
    <view class="box8 flex-col">
      <view class="outer3 flex-row justify-between u-col-center">
        <text class="word5">票价：</text>
				<u-input
					:border="false"
					class="u-flex-1"
					v-model="form.price"
    ...
    <view class="box9 flex-col">
      <view class="section3 flex-row justify-between u-col-center">
