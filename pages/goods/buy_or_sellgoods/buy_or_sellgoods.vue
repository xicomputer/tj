...
<!--      <text class="font1"><text class="u-font-26">￥</text>{{skuMap.showPrice}}</text>-->
    ...
    <u-popup v-model="skushow" mode="bottom">
      <view class="pop-box">
          ...
          <view class="info">
			...
			<view style="display: flex;align-items: center;">
				<!-- <view style="display: flex;align-items: center;margin-right: 20rpx;">
				 	<view style="color: white;background:#ff0000 ;padding: 9rpx 4rpx;border-bottom-left-radius: 8rpx;border-top-left-radius: 8rpx;">自购返佣 </view>
				 	<text style="color: #ff0000;border: 2px solid #ff0000;padding: 5rpx 0;border-bottom-right-radius: 8rpx;border-top-right-radius: 8rpx;padding-right: 8rpx;">
						
						￥{{onepra.showCommission?onepra.showCommission:skuMap.showCommission }}
					</text>     
				 </view> -->
        ...
        <view class="x-btn"  @tap="place_order" style="background-color: #ff0000;">
