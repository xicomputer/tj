          ...
          drawArray: ({
            ...
            return new Promise((rs, rj) => {
              rs([
                ...
                {
                  type: 'image',    //商品图
                  url:hbmap.activity.commodity.thumbnail,
                  roundRectSet:2,
                  infoCallBack(imageInfo) {
                    let scale = bgObj.width * 0.2 / imageInfo.height;
                    console.log(bgObj.width , imageInfo.width*scale,999)
                    return {
                      dWidth: 1000, // 因为设置了圆形图片 所以要乘以2
                      dHeight:1100,
                      dx: 40,
                      dy: 250,
                      /* roundRectSet: { // 圆角矩形
                ...
                {
                  type: 'image',
                  url: hbmap.userInfo.headImgUrl,
                  roundRectSet:100,
                  infoCallBack(imageInfo) {
                    let scale = bgObj.width * 0.15 / imageInfo.height;
                    console.log(bgObj.width , imageInfo.width*scale,999)
                    return {
                ...
                },
                {
                  ...
                  infoCallBack(textLength) {
                    // console.log(bgObj.height, textLength,1111111111111111)
                    return {
                      dx: 220+textLength/2,
                      dy: 50
                    }
                ...
                {
                  type: 'text',
                  text: '￥'+ hbmap.activity.commodity.showPrice,
                  size: 80,
                  color: '#FF6D2E',
                  alpha: 1,
                  textBaseline: 'top',
